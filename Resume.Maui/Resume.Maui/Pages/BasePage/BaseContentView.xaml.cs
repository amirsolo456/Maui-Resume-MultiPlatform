...
namespace Resume.Maui.Pages.BasePage;

public partial class BaseContentView : RadContentView
{
    ...
    public static readonly BindableProperty HeaderControlTemplateProperty =
        BindableProperty.Create(nameof(HeaderControlTemplate), typeof(ControlTemplate), typeof(BaseContentView), null);

    public static readonly BindableProperty BodyControlTemplateProperty =
        BindableProperty.Create(nameof(BodyControlTemplate), typeof(ControlTemplate), typeof(BaseContentView), null);
