        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_NavigationItems_NavigationItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Educations_NavigationItems_NavigationItemId",
                        column: x => x.NavigationItemId,
                        principalTable: "NavigationItems",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_NavigationItems_NavigationItemId",
                        column: x => x.NavigationItemId,
                        principalTable: "NavigationItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Skills_NavigationItems_NavigationItemId",
                        column: x => x.NavigationItemId,
                        principalTable: "NavigationItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkExperiences_NavigationItems_NavigationItemId",
                        column: x => x.NavigationItemId,
                        principalTable: "NavigationItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_NavigationItemId",
                table: "Contacts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Educations_NavigationItemId",
                table: "Educations",
                column: "NavigationItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NavigationItems_KeyName",
                table: "NavigationItems",
                column: "KeyName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Projects_NavigationItemId",
                table: "Projects",
                column: "NavigationItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Skills_NavigationItemId",
                table: "Skills",
                column: "NavigationItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkExperiences_NavigationItemId",
